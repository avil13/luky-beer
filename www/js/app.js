...
angular.module('app', [
    ...
    'app.controllers.luck',
    'app.controllers.list',
])

.config(['$ionicConfigProvider', '$sceDelegateProvider', function($ionicConfigProvider, $sceDelegateProvider) {

    $sceDelegateProvider.resourceUrlWhitelist(['self', '*://lab.swew.ru/**',  '*://www.youtube.com/**', '*://player.vimeo.com/video/**']);
...
.run(['$ionicPlatform', '$rootScope',
    function($ionicPlatform, $rootScope) {
        ...
        $rootScope.selectedBar = {}; // переменная для хранения выбранного бара
